...
Konvertiert den String in ein entsprechendes [TimeSpan](../)-Objekt unter Verwendung des angegebenen Formats, des Formatproviders und der Stile.
...
| --- | --- | --- |
| Eingabe | const String\& | Eingabezeichenkette. |
| Format | const String\& | Standard- oder benutzerdefinierter Formatstring. |
| Anbieter | const SharedPtr\<IFormatProvider\>\& | Formatprovider, der kulturspezifische Formatierungsinformationen bereitstellt. |
| Stile | Globalization::TimeSpanStyles | Definiert Elemente, die im Eingabestring vorhanden sein können. |
