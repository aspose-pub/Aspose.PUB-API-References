...
description: "System::Xml::XmlReader::ReadToDescendant Methode. Bewegt den XmlReader in C++ zum nächsten Nachfahren‑Element mit dem angegebenen lokalen Namen und Namespace‑URI."
type: docs
weight: 7100
...
Bewegt den [XmlReader](../) zum nächsten Nachfahren‑Element mit dem angegebenen lokalen Namen und Namespace‑URI.
...
Bewegt den [XmlReader](../) zum nächsten Nachfahren‑Element mit dem angegebenen qualifizierten Namen.
