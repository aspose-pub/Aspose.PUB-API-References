...
description: "System::Xml::XmlSignificantWhitespace sınıfı. Karışık içerikli bir düğümde işaretleme arasındaki boşlukları veya xml:space=''preserve'' kapsamındaki boşlukları temsil eder. Bu, C++'da aynı zamanda anlamlı boşluk olarak da adlandırılır."
type: docs
weight: 3700
...
Karışık içerikli bir düğümde işaretleme arasındaki boşlukları veya **xml:space='preserve'** kapsamı içindeki boşlukları temsil eder. Bu aynı zamanda anlamlı boşluk olarak da adlandırılır.
