...
description: "System::Int16::Parse yöntemi. Belirtilen sayının dize temsilini içeren dizeyi C++'ta eşdeğer 16 bit işaretli tam sayıya dönüştürür."
type: docs
weight: 100
...
Belirtilen sayının dize temsili içeren dizeyi, sağlanan biçimlendirme bilgilerini kullanarak eşdeğer 16-bit işaretli tam sayıya dönüştürür.
