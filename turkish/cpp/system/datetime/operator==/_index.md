...
description: "System::DateTime::operator== yöntemi. Geçerli nesne ile belirtilen DateTime nesnesinin aynı tarih ve saat değerini temsil edip etmediğini C++'ta belirler."
type: docs
weight: 3900
...
Geçerli nesne ve belirtilen nesne aynı tarih ve saat değerini temsil ediyorsa doğru, aksi takdirde - yanlış.
