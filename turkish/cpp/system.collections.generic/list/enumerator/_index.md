...
description: "System::Collections::Generic::List::Enumerator sınıfı. Liste öğeleri üzerinde yineleme yapmak için bir Enumerator. Bu sınıfın nesneleri yalnızca System::MakeObject() işlevi kullanılarak ayrılmalıdır. Yığını (stack) üzerinde veya new operatörüyle bu tür bir örnek asla oluşturulmamalıdır, çünkü çalışma zamanı hatalarına ve/veya doğrulama hatalarına yol açar. Bu sınıfı her zaman System::SmartPtr işaretçisine sarın ve bu işaretçiyi C++'ta fonksiyonlara argüman olarak geçirin."
type: docs
weight: 6100
...
| Yöntem | Açıklama |
| --- | --- |
| [Enumerator](./enumerator/)(const ThisPtr\&) | Belirli bir liste üzerinde yineleme yapan enumerator oluşturur. |
## Ayrıca Bakınız
