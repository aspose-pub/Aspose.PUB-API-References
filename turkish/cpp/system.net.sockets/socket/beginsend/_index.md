...
description: "System::Net::Sockets::Socket::BeginSend yöntemi. C++'ta asenkron bir gönderim işlemi başlatır."
type: docs
weight: 900
...
| --- | --- | --- |
| tampon | System::ArrayPtr\<uint8_t\> | Veri okunacak bir tampon. |
...
| socketFlags | SocketFlags | Gönderim davranışı. |
| geri çağırma | AsyncCallback | İşlem tamamlandığında çağrılacak bir geri çağırma. |
| durum | System::SharedPtr\<Object\> | Her asenkron gönderim işlemini benzersiz şekilde tanımlamak için kullanıcı tarafından sağlanan veri. |
