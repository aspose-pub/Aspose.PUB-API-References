...
![Aspose.PUB for .NET logo](home_1.png)
...
- [Aspose.PUB for .NET API Reference](/pub/net/)

## Aspose.PUB for Java

{{% alert color="primary" %}}

![Aspose.PUB for Java logo](home_2.png)
...
- [Aspose.PUB for Java API Reference](/pub/java/)
...
![Aspose.PUB for C++ logo](home_3.png)
...
These are links to some useful resources:
- [Aspose.PUB for C++ API Reference](/pub/cpp/)
