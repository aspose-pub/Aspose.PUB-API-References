...
| 命名空间 | 描述 |
| --- | --- |
| [Aspose.Pub](./aspose.pub) | 的 **Aspose.Pub**命名空间提供描述 PUB 对象的类。 |
| [Aspose.Pub.Exceptions](./aspose.pub.exceptions) | 命名空间异常声明了 PUB 区域中的异常类 |
| [Aspose.Pub.Utils](./aspose.pub.utils) | 命名空间 Aspose.PUB.Utils 提供了一个实用程序 objects |
